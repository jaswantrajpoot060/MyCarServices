...
{
    public class ApplyUser : BaseObject
    {
        #region Property
        ...
        [Required(ErrorMessage = "Please Fill Your Full Package Name")]
        ...
        [Required(ErrorMessage = "Please Fill Your License Number")]
        public string LicenseNumber { get; set; }

        [Required(ErrorMessage = "Please Fill Your License Image")]
        public string LicenseImg { get; set; }

        [Required(ErrorMessage = "Please Fill Your Date of Birth")]
        ...
        public ApplyUser(IDataReader reader)
            : base(reader)
        {
